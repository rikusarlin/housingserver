# housingserver
Spring Boot Rest service, with validations done using Spring Validation and ORM stuff done with Spring Data repository backed by H2 database. The actual Rest service is generated by openapi-generator from an OpenApi 3.0 specification. 
...
By default, the system uses file-based H2 database. It can be accessed via the following address:
http://localhost:8080/h2

Database URL is "jdbc:h2:file:./testdb;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE", username is "sa" and password is empty (!).
