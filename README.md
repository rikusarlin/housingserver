# housingserver
Quarkus Rest service, with validations done using Spring Validation and ORM stuff done with Hibernate backed by H2 database or PostgreSQL. The actual Rest service is generated by openapi-generator from an OpenApi 3.0 specification. 
...
* Quarkus: the basic framework tying it all together
...
* Hibernate Validation: entity validation
